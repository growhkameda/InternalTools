...
public class UserService {
    ...
    @Transactional
    public void updateUser(Integer userId, String userName, String birthDate, String hobby, String image, String joiningMonth, String mbti, List<TRelUserDepartmentEntity> tRelUserDepartmentEntityList) {
    	
    	try {
    		 // `t_user` を更新
            tUserService.updateUser(userId, userName, birthDate, hobby, image, joiningMonth, mbti);
