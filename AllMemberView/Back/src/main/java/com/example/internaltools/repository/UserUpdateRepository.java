...
public interface UserUpdateRepository extends CrudRepository<UserUpdateEntity, Integer> {
    ...
    @Modifying
    @Transactional
    @Query("UPDATE UserUpdateEntity u SET u.userName = :userName, u.birthDate = :birthDate, u.hobby = :hobby, u.image = :image , u.joiningMonth = :joiningMonth WHERE u.userId = :userId")
