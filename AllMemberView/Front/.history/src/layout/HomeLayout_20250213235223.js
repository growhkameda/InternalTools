...
const Home = () => {
  ...
  const [year, setYear]           = useState(2025); //ダミーとして2025年を指定
  const [targetMonth, setMonth]   = useState(8)     //ダミーとして8月を指定

  //社員データを取得する
  useEffect(() => {
    const allEmployees = [
      { empName: "佐藤", joinYear: 2025, JoinMonth: 8 },
      { empName: "鈴木", joinYear: 2025, JoinMonth: 8 },
      { empName: "山田", joinYear: 2025, JoinMonth: 8 },
    ];
